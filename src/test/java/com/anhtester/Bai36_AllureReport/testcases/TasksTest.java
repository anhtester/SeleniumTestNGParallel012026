...
import com.anhtester.Bai36_AllureReport.pages.TasksPage;
...
@Epic("Quản lý công việc")
@Feature("Thêm mới công việc")
public class TasksTest extends BaseTest {
   ...
   @Link(name = "DEV-5870", url = "https://slope.atlassian.net/browse/DEV-5870")
   @Severity(SeverityLevel.CRITICAL)
   @Description("Thêm mới công việc gắn với dự án đã tạo")
   @Owner("Anh Tester")
   @Test
