...
public class DashboardPage extends BasePage {
   ...
   @Step("Kiểm tra đã đến được trang Dashboard")
   ...
   @Step("Kiểm tra tổng Invoices Awaiting Payment là {0}")
   ...
   @Step("Kiểm tra tổng Converted Leads là {0}")
   ...
   @Step("Kiểm tra tổng Projects In Progress là {0} / {1}")
   ...
   @Step("Kiểm tra tổng Tasks Not Finished là {0}")
