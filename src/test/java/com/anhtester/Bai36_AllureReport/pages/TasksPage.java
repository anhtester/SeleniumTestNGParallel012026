...
public class TasksPage extends BasePage {
   ...
   @Step("Kiểm tra đã đến được trang Tasks")
   ...
   @Step("Lấy tên Task trên modal chi tiết")
   ...
   @Step("Lấy Project gắn với Task {0}")
